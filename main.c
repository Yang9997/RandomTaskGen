...
const gchar* tasks[] = {
    ...
    "身体技能：例如倒立支撑30s 泰拳连招 5分钟跑完一英里 后空翻等",
    "24小时内容创作挑战：流程是头脑风暴 选择idea 写脚本 拍摄 剪辑 发布",
    "掌握一道招牌菜：没做过的 美味可口的 精致漂亮的 邀请人来品尝",
    "定制自己的环境：打理空间 改造它 装饰它 按自己的想法",
    "七日身份体验：例如今天的身份是 6点起床 不吃垃圾食品 不吃玉米 10个俯卧撑 不抱怨 读20页书 写日记 洗热水澡",
    "技能叠加：每天一小时学习技能 例如视频剪辑 演讲训练 记忆技巧 内容创作 或其他新技能 并记录全过程",
    "独处体验日：独自看电影 独自泡咖啡馆 独自下馆子 独自逛博物馆 开车去附近陌生的小镇 步行漫游 骑行 不能带耳机 不碰手机",
    "用七天时间记录自己的生活：1.每天录10s视频 2.每天自拍 3.每天日记 最终剪辑成集锦",
    "用七天时间增进计算机技能：选定一个计算机小项目来完成 整理项目原理项目目的和项目结果"
};
